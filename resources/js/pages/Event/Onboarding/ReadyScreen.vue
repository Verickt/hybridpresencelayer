...
<template>
    <div class="flex min-h-screen flex-col items-center bg-white px-6 pt-6 pb-8">
        ...
        <div class="mt-16 flex flex-col items-center">
            ...
            <h1 class="mt-6 text-center text-2xl font-bold text-neutral-900">You're all set!</h1>
            <p class="mt-2 text-center text-sm text-neutral-500">
                {{ user.participant_type === 'physical' ? 'Physical' : 'Remote' }} attendee interested in {{ user.interest_tags.join(', ') }}
            </p>
        </div>
        ...
        <div class="mt-10 flex flex-col items-center">
            ...
            <p class="mt-2 text-xs text-neutral-400">Others can scan to connect with you</p>
        </div>
